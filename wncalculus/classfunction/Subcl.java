...
/**
 * this class defines sub-classes of a color class, denoted by C{i}, where index
 * i refers to the color class partition's element (what is usually referred to
 * as "static subclass")
 *
...
public final class Subcl extends ConstantFunction {
     ...
     * @throws IllegalArgumentException if, for any reasons, some of the
    ...
    public static Subcl factory(int i, ColorClass cc) {
        ...
        if (i < 1 || i > cc.subclasses()) {
            ...
            Subcl s;
            final var k = new ComplexKey(cc, i);
    ...
    public SetFunction opposite() {
        ...
        final var howmany = cc.subclasses();
        final Set<SetFunction> complset = new HashSet<>();
